  ...
  packages = [
    {
      ...
      path = fetchurl {
        name = "_fast_csv_format___format_4.3.5.tgz";
        url =
          "https://registry.yarnpkg.com/@fast-csv/format/-/format-4.3.5.tgz";
        sha512 =
          "8iRn6QF3I8Ak78lNAa+Gdl5MJJBM5vRHivFtMRUWINdevNo00K7OXxS2PshawLKTejVwieIlPmK5YlLu6w4u8A==";
      };
    }
    {
      ...
      path = fetchurl {
        ...
        sha512 =
          "uRsLYksqpbDmWaSmzvJcuApSEe38+6NQZBUsuAyMZKqHxH0g1wcJgsKUvN3WC8tewaqFjBMMGrkHmC+T7k8LvA==";
      };
    }
    {
      ...
      path = fetchurl {
        name = "_oscal_oscal_deep_diff___oscal_deep_diff_1.0.0.tgz";
        url =
          "https://registry.yarnpkg.com/@oscal/oscal-deep-diff/-/oscal-deep-diff-1.0.0.tgz";
        sha512 =
          "uEFINkFsrJWxp/MyPH5zhEVinm0qSQEopp8GMEqvR0lB1/PlLr98vf0Tk8DMQ8lyEq60ylAwhMb6YLKeewmr+A==";
      };
    }
    {
    ...
    }
    {
      ...
      path = fetchurl {
        ...
        sha512 =
          "hTAeo5b5TPvf8Z02I2sKIT4kSfCnOO2bCxYX8ABqODCdAjppI3gI9VYiGCQQYVcBaBSKlFDMKlAQRqC+kV9O8w==";
      };
    }
    {
      ...
      path = fetchurl {
        ...
        sha512 =
          "2RNSpuwwsJGP0frGsOmTb9oUF+VkFSM4SyLTDgwf2ciHWTarN0lQTC+F2f/t5J9QjW+c65VFIAAu85GsvMIusw==";
      };
    }
    {
    ...
    }
    {
      ...
      path = fetchurl {
        name = "lodash.groupby___lodash.groupby_4.6.0.tgz";
        url =
          "https://registry.yarnpkg.com/lodash.groupby/-/lodash.groupby-4.6.0.tgz";
        sha512 =
          "5dcWxm23+VAoz+awKmBaiBvzox8+RqMgFhi7UvX9DHZr2HdxHXM/Wrf8cfKpsW37RNrvtPn6hSwNqurSILbmJw==";
      };
    }
    {
    ...
    }
    {
      ...
      path = fetchurl {
        ...
        sha512 =
          "AirXNj15uRIMMPihnkInB4i3NHeb4iBtNg9WRWuK2o31S+ePwwNmDPaTL3o7dTJ+VXNZim7rFs4rxN4YU1oUJw==";
      };
    }
    {
      ...
      path = fetchurl {
        name = "lodash.isnil___lodash.isnil_4.0.0.tgz";
        url =
          "https://registry.yarnpkg.com/lodash.isnil/-/lodash.isnil-4.0.0.tgz";
        sha512 =
          "up2Mzq3545mwVnMhTDMdfoG1OurpA/s5t88JmQX809eH3C8491iu2sfKhTfhQtKY78oPNhiaHJUpT/dUDAAtng==";
      };
    }
    {
    ...
    }
    {
      ...
      path = fetchurl {
        ...
        sha512 =
          "MXB1is3s899/cD8jheYYE2V9qTHwKvt+npCwpD+1Sxm3Q3cECXCiYHjeHWXNwr6Q0SOBPrYUDxendrO6goVTEA==";
      };
    }
    {
    ...
    }
    {
      ...
      path = fetchurl {
        ...
        sha512 =
          "6RLVvwJtVwEDfPdn6X6Ille4/lxGl0ATOY4FN/B9nxQcgOazvvI0nodiD19ScKq0PvA/29VpaOQML36o5IzZWA==";
      };
    }
    {
